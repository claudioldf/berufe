...
| Private        | Phone, moderation notes, draft quotes/customer details, and six-month LLM search prompts/output                                         | Owner/admin access only as required; search audit content is never logged.                              |
