...
| Private        | Phone, moderation notes, draft quotes/customer details, and seven-day LLM search prompts/output                                        | Owner/admin access only as required; search audit content is never logged.                              |
