...
class ProfessionalQuoteIndexQuery
  ...
  def call(
    ...
    filters = normalize_filters(search:, status:, scheduled_on:, sort:, direction:, page:, per_page:)
  ...
  def normalize_filters(search:, status:, scheduled_on:, sort:, direction:, page:, per_page:)
