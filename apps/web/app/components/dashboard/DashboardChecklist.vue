...
<template>
  <DesignSystemSurfaceCard as="section" class="checklist-card">
    ...
    <p v-if="pendingItems.length">
      Complete estas etapas para mostrar mais evidências aos clientes.
    </p>
    <div v-if="pendingItems.length" class="checklist-card__items">
      <NuxtLink v-for="item in pendingItems" :key="item.id" :to="item.to">
