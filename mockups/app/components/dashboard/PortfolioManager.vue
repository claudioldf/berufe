...
<style scoped>
.portfolio-manager { display: grid; gap: 18px; }.portfolio-manager__intro { display: flex; justify-content: space-between; align-items: end; gap: 30px; padding: 26px; }.portfolio-manager__intro h2 { margin: 0; font-family: Georgia, serif; font-size: 2rem; }.portfolio-manager__intro p:last-child { max-width: 580px; margin: 7px 0 0; color: var(--ink-soft); font-size: .7rem; line-height: 1.5; }.portfolio-manager__grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; }.portfolio-manager__grid article { position: relative; overflow: hidden; border: 1px solid var(--line); border-radius: 16px; background: white; }.portfolio-manager__grid article > img { width: 100%; height: 190px; object-fit: cover; }.portfolio-manager__grid article > div { display: flex; justify-content: space-between; gap: 8px; padding: 13px; }.portfolio-manager__grid strong, .portfolio-manager__grid small { display: block; }.portfolio-manager__grid strong { font-size: .7rem; }.portfolio-manager__grid small { margin-top: 3px; color: var(--ink-soft); font-size: .59rem; }.portfolio-manager__grid em { align-self: start; padding: 4px 6px; border-radius: 6px; background: #e5f3ee; color: #2e6f5e; font-size: .53rem; font-style: normal; font-weight: 900; }.portfolio-manager__grid article > button { position: absolute; top: 9px; right: 9px; display: grid; place-items: center; width: 31px; height: 31px; border: 0; border-radius: 9px; background: rgba(255,255,255,.92); cursor: pointer; }.portfolio-manager__order { position: absolute; top: 9px; left: 9px; display: flex; align-items: center; gap: 3px; padding: 6px 7px; border-radius: 8px; background: rgba(23,53,47,.82); color: white; font-size: .55rem; }.portfolio-manager__add { min-height: 260px; display: grid; place-items: center; align-content: center; gap: 5px; border: 1px dashed #9ab9af; border-radius: 16px; background: transparent; color: #397a69; cursor: pointer; }.portfolio-manager__add > svg { margin-bottom: 5px; font-size: 1.5rem; }.portfolio-manager__add small { color: var(--ink-soft); }.portfolio-upload { display: grid; gap: 14px; }.portfolio-upload label { display: grid; gap: 6px; color: var(--ink); font-size: .67rem; font-weight: 800; }.portfolio-upload input, .portfolio-upload select, .portfolio-upload textarea { padding: 10px 11px; border: 1px solid var(--line); border-radius: 9px; outline: 0; }.portfolio-upload textarea { min-height: 90px; }.portfolio-upload__drop { position: relative; place-items: center; padding: 30px; border: 1px dashed #8eb6aa; border-radius: 13px; background: #eff7f4; text-align: center; cursor: pointer; }.portfolio-upload__drop svg { color: #397a69; font-size: 1.8rem; }.portfolio-upload__drop small { color: var(--ink-soft); }.portfolio-upload__drop input { position: absolute; inset: 0; opacity: 0; cursor: pointer; }
