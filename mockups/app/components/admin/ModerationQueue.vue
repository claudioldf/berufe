...
<style scoped>
.moderation { display: grid; gap: 14px; }.moderation__toolbar { display: flex; justify-content: space-between; align-items: center; gap: 20px; }.moderation__filters { display: flex; overflow-x: auto; gap: 5px; }.moderation__filters button { padding: 7px 10px; border: 1px solid var(--line); border-radius: 8px; background: white; color: var(--ink-soft); font-size: .72rem; font-weight: 800; white-space: nowrap; cursor: pointer; }.moderation__filters button.active { border-color: #397a69; background: #397a69; color: white; }.moderation__toolbar label { display: flex; align-items: center; gap: 7px; width: 220px; padding: 8px 10px; border: 1px solid var(--line); border-radius: 9px; background: white; color: var(--ink-soft); }.moderation__toolbar input { min-width: 0; width: 100%; border: 0; outline: 0; font-size: .75rem; }.moderation__workspace { display: grid; grid-template-columns: minmax(280px, .65fr) minmax(430px, 1.35fr); overflow: hidden; min-height: 610px; border: 1px solid var(--line); border-radius: 18px; background: white; }.moderation__list { overflow-y: auto; border-right: 1px solid var(--line); background: #f8f7f3; }.moderation__list > button { display: grid; grid-template-columns: auto 1fr auto; gap: 10px; width: 100%; padding: 15px 13px; border: 0; border-bottom: 1px solid var(--line); border-left: 3px solid transparent; background: transparent; color: var(--ink); text-align: left; cursor: pointer; }.moderation__list > button:hover { background: white; }.moderation__list > button.active { border-left-color: #397a69; background: white; }.moderation__list > button.priority { border-left-color: var(--coral); }.moderation__type-icon { display: grid; place-items: center; width: 34px; height: 34px; border-radius: 10px; background: var(--mint); color: #397a69; }.moderation__list em, .moderation__list strong, .moderation__list small { display: block; }.moderation__list em { color: #397a69; font-size: .70rem; font-style: normal; font-weight: 900; text-transform: uppercase; }.moderation__list strong { overflow: hidden; margin-top: 3px; font-size: .78rem; text-overflow: ellipsis; white-space: nowrap; }.moderation__list small { margin-top: 3px; color: var(--ink-soft); font-size: .72rem; }.moderation__age { color: var(--ink-soft); font-size: .70rem; }.moderation__filtered-empty { padding: 30px; color: var(--ink-soft); font-size: .78rem; text-align: center; }.moderation__review { display: flex; flex-direction: column; min-width: 0; padding: 24px; }.moderation__review > header { display: flex; justify-content: space-between; gap: 20px; }.moderation__review > header span { color: #397a69; font-size: .72rem; font-weight: 900; text-transform: uppercase; }.moderation__review > header h2 { margin: 4px 0 0; font-family: Georgia, serif; font-size: 1.65rem; }.moderation__review > header p { margin: 4px 0 0; color: var(--ink-soft); font-size: .75rem; }.moderation__review > header button { display: grid; place-items: center; width: 32px; height: 32px; border: 1px solid var(--line); border-radius: 9px; background: white; cursor: pointer; }.moderation__meta { display: flex; gap: 16px; padding: 14px 0; margin: 17px 0; border-block: 1px solid var(--line); color: var(--ink-soft); font-size: .72rem; }.moderation__meta span { display: flex; align-items: center; gap: 4px; }.moderation__review-block > span, .moderation__note > span { color: var(--ink-soft); font-size: .70rem; font-weight: 900; text-transform: uppercase; }.moderation__review-block p { margin: 5px 0 0; font-size: .78rem; line-height: 1.55; }.moderation__preview { display: grid; grid-template-columns: auto 1fr; gap: 12px; align-items: center; padding: 17px; margin-top: 16px; border: 1px solid var(--line); border-radius: 13px; background: #f8f7f3; }.moderation__preview > div { display: grid; place-items: center; width: 48px; height: 48px; border-radius: 12px; background: white; color: #397a69; font-size: 1.25rem; }.moderation__preview small { color: var(--ink-soft); font-size: .70rem; font-weight: 850; text-transform: uppercase; }.moderation__preview p { margin: 5px 0 0; font-family: Georgia, serif; font-size: .83rem; line-height: 1.4; }.moderation__private-warning { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 10px; padding: 13px; margin-top: 13px; border: 1px solid #eccf8c; border-radius: 11px; background: #fff9e8; color: #8c671b; }.moderation__private-warning strong, .moderation__private-warning small { display: block; }.moderation__private-warning strong { font-size: .75rem; }.moderation__private-warning small { margin-top: 2px; color: #8d7a50; font-size: .70rem; }.moderation__note { display: grid; gap: 6px; margin-top: 17px; }.moderation__note textarea { min-height: 75px; padding: 10px; border: 1px solid var(--line); border-radius: 9px; outline: none; font-size: .75rem; resize: vertical; }.moderation__review > footer { display: flex; justify-content: flex-end; gap: 7px; padding-top: 18px; margin-top: auto; border-top: 1px solid var(--line); }.moderation__empty { padding: 70px 30px; text-align: center; }.moderation__empty > span { display: grid; place-items: center; width: 60px; height: 60px; margin: auto; border-radius: 18px; background: var(--mint); color: #397a69; font-size: 1.5rem; }.moderation__empty h2 { margin: 15px 0 4px; font-family: Georgia, serif; font-size: 2rem; }.moderation__empty p { margin: 0; color: var(--ink-soft); font-size: .7rem; }.rejection-form { display: grid; gap: 7px; }.rejection-form > span { font-size: .78rem; font-weight: 850; }.rejection-form textarea { min-height: 130px; padding: 11px; border: 1px solid var(--line); border-radius: 10px; outline: none; resize: vertical; }.rejection-form small { justify-self: end; color: var(--ink-soft); font-size: .72rem; }
