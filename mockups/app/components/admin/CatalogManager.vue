...
<style scoped>
.catalog { overflow: hidden; }.catalog > header { display: flex; justify-content: space-between; align-items: center; gap: 20px; padding: 22px; }.catalog h2, .catalog p { margin: 0; }.catalog h2 { font-family: Georgia, serif; font-size: 1.5rem; }.catalog p { margin-top: 4px; color: var(--ink-soft); font-size: .65rem; }.catalog nav { display: flex; gap: 4px; padding: 0 22px; border-bottom: 1px solid var(--line); }.catalog nav button { padding: 10px 12px; border: 0; border-bottom: 2px solid transparent; background: transparent; color: var(--ink-soft); font-size: .65rem; font-weight: 850; cursor: pointer; }.catalog nav button.active { border-bottom-color: #397a69; color: #397a69; }.catalog nav span { margin-left: 4px; padding: 2px 5px; border-radius: 5px; background: #eeece6; font-size: .52rem; }.catalog__head, .catalog__row { display: grid; grid-template-columns: 70px 1.5fr 1fr 90px 75px; gap: 12px; align-items: center; padding: 11px 20px; }.catalog__head { background: #f0eee8; color: var(--ink-soft); font-size: .53rem; font-weight: 900; text-transform: uppercase; }.catalog__row { border-top: 1px solid var(--line); min-height: 66px; }.catalog__order { display: flex; align-items: center; gap: 5px; color: var(--ink-soft); font-size: .6rem; cursor: grab; }.catalog__row strong, .catalog__row small { display: block; }.catalog__row strong { font-size: .66rem; }.catalog__row small { overflow: hidden; max-width: 400px; margin-top: 3px; color: var(--ink-soft); font-size: .54rem; text-overflow: ellipsis; white-space: nowrap; }.catalog__row code { color: var(--ink-soft); font-size: .56rem; }.catalog__status, .catalog__edit { display: inline-flex; align-items: center; gap: 5px; border: 0; background: transparent; color: #31715f; font-size: .57rem; font-weight: 850; cursor: pointer; }.catalog__status i { width: 7px; height: 7px; border-radius: 99px; background: #4caf8e; }.catalog__status.inactive { color: #8a7772; }.catalog__status.inactive i { background: #a79792; }.catalog__edit { color: var(--ink-soft); }
