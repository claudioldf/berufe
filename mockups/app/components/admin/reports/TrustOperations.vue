...
<style scoped>
.trust-ops { display: grid; grid-template-columns: 1.2fr .8fr; gap: 12px; }.network-card, .quote-card, .ops-card { padding: 20px; }.network-card header h2, .network-card header p, .network-card header span, .quote-card header h2, .quote-card header p, .quote-card header span, .ops-card header h2, .ops-card header p { margin: 0; }.network-card h2, .quote-card h2, .ops-card h2 { margin-top: 2px !important; font-family: Georgia, serif; font-size: 1.25rem; font-weight: 500; }.network-card header span, .quote-card header div > span { display: block; margin-top: 4px; color: var(--ink-soft); font-size: .7rem; }.section-kicker { color: #397a69; font-size: .68rem; font-weight: 900; letter-spacing: .12em; text-transform: uppercase; }
.network-list { display: grid; gap: 8px; margin-top: 17px; }.network-list > div { padding: 12px; border-radius: 12px; background: #f7f5f0; }.network-list > div > strong { font-size: .72rem; }.network-values { display: grid; grid-template-columns: 1fr auto 1fr auto 1fr; align-items: center; gap: 8px; margin-top: 9px; }.network-values > span { display: flex; align-items: baseline; gap: 4px; }.network-values b { font-family: Georgia, serif; font-size: 1rem; }.network-values small { color: var(--ink-soft); font-size: .61rem; }.network-values > svg { color: #a1aaa6; font-size: .7rem; }.network-list p { margin: 7px 0 0; color: #397a69; font-size: .62rem; font-weight: 800; }
.quote-card header, .ops-card header { display: flex; justify-content: space-between; gap: 10px; }.rate-chip { align-self: start; padding: 6px 8px; border-radius: 8px; background: #e8f4f0; color: #397a69; font-size: .65rem; font-weight: 850; white-space: nowrap; }.quote-numbers { display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; gap: 10px; margin-top: 26px; }.quote-numbers > div { padding: 13px; border-radius: 12px; background: #f7f5f0; text-align: center; }.quote-numbers strong, .quote-numbers small { display: block; }.quote-numbers strong { font-family: Georgia, serif; font-size: 1.6rem; }.quote-numbers small { color: var(--ink-soft); font-size: .67rem; }.quote-numbers > svg { color: #397a69; }.quote-people { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-top: 10px; }.quote-people > div { display: flex; align-items: center; gap: 8px; padding: 10px; border: 1px solid var(--line); border-radius: 11px; }.quote-people svg { color: #705e93; }.quote-people strong, .quote-people small { display: block; }.quote-people strong { font-size: .8rem; }.quote-people small { color: var(--ink-soft); font-size: .6rem; }
.ops-card { grid-column: 1 / -1; }.ops-card header > span { display: flex; align-items: center; gap: 6px; align-self: start; padding: 6px 9px; border-radius: 9px; background: #e8f4f0; color: #397a69; font-size: .67rem; font-weight: 850; }.ops-card header > .ops-card__alert { background: #fff2cf; color: #8d6813; }.ops-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 9px; margin-top: 17px; }.ops-grid > div { padding: 13px; border-radius: 11px; background: #f7f5f0; }.ops-grid span, .ops-grid strong, .ops-grid small { display: block; }.ops-grid span { color: var(--ink-soft); font-size: .66rem; }.ops-grid strong { margin-top: 6px; font-family: Georgia, serif; font-size: 1.35rem; }.ops-grid small { margin-top: 2px; color: var(--ink-soft); font-size: .61rem; }.ops-card footer { display: flex; align-items: center; gap: 7px; margin-top: 12px; color: var(--ink-soft); font-size: .66rem; }.ops-card footer svg { color: #b9533e; }
