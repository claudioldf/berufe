...
.section-heading h2, .section-heading p { margin: 0; }.section-heading h2 { margin-top: 2px; font-family: Georgia, serif; font-size: 1.55rem; font-weight: 500; }.section-heading > p { max-width: 390px; color: var(--ink-soft); font-size: .75rem; line-height: 1.5; text-align: right; }
...
.discovery-stage__top { display: flex; justify-content: space-between; gap: 10px; }.discovery-stage__top span, .discovery-stage__top strong { font-size: .76rem; }.discovery-stage__bar { height: 8px; margin-top: 6px; overflow: hidden; border-radius: 99px; background: #e9e8e3; }.discovery-stage__bar i { display: block; height: 100%; border-radius: inherit; background: linear-gradient(90deg, #f8755d, #f4a18f); }.discovery-stage small { display: block; margin-top: 3px; color: var(--ink-soft); font-size: .64rem; }
.demand-card, .gaps-card { padding: 20px; }.demand-card header, .gaps-card header { display: flex; justify-content: space-between; gap: 12px; }.demand-card h3, .demand-card p, .gaps-card h3, .gaps-card p { margin: 0; }.demand-card h3, .gaps-card h3 { font-family: Georgia, serif; font-size: 1.15rem; font-weight: 500; }.demand-card p, .gaps-card p { margin-top: 3px; color: var(--ink-soft); font-size: .7rem; }.demand-card header > svg { color: #397a69; font-size: 1.2rem; }
.demand-bars { display: grid; gap: 13px; margin-top: 23px; }.demand-bars > div { display: grid; grid-template-columns: 110px 1fr 28px; align-items: center; gap: 8px; }.demand-bars span, .demand-bars strong { font-size: .74rem; }.demand-bars i { height: 7px; overflow: hidden; border-radius: 99px; background: #e9e8e3; }.demand-bars b { display: block; height: 100%; border-radius: inherit; background: #397a69; }.demand-bars strong { text-align: right; }
.gaps-card { grid-column: 1 / -1; }.gaps-card header > span { align-self: start; padding: 6px 8px; border-radius: 8px; background: #fff0ec; color: #b9533e; font-size: .67rem; font-weight: 850; }.gaps-list { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; margin-top: 17px; }.gaps-list > div { display: grid; grid-template-columns: auto 1fr; gap: 9px; padding: 12px; border-radius: 12px; background: #f7f5f0; }.gaps-list > div > span { display: grid; place-items: center; width: 32px; height: 32px; border-radius: 9px; background: #fff0ec; color: #b9533e; }.gaps-list > div > .gaps-list__icon--catalog { background: #fff7de; color: #8a6918; }.gaps-list strong, .gaps-list small { display: block; }.gaps-list strong { font-size: .73rem; line-height: 1.35; }.gaps-list small { margin-top: 3px; color: var(--ink-soft); font-size: .66rem; }.gaps-list em { grid-column: 2; color: #397a69; font-size: .65rem; font-style: normal; font-weight: 850; }
