...
.professional-card__verified { position: absolute; left: 12px; bottom: 12px; display: inline-flex; align-items: center; gap: 5px; padding: 7px 9px; border-radius: 10px; background: rgba(255,255,255,.92); color: #266253; font-size: .86rem; font-weight: 800; backdrop-filter: blur(8px); }
.professional-card__body { padding: 22px 24px; }
.professional-card__topline { display: flex; justify-content: space-between; gap: 14px; color: #397a69; font-size: .86rem; font-weight: 800; letter-spacing: .05em; text-transform: uppercase; }
...
.professional-card__coverage { display: flex; align-items: center; gap: 6px; margin: 10px 0 0; color: var(--ink); font-size: .84rem; font-weight: 700; }
.professional-card__evidence { display: flex; flex-wrap: wrap; gap: 6px; margin-top: 16px; }
.professional-card__proof { display: flex; gap: 18px; margin-top: 17px; color: var(--ink-soft); font-size: .86rem; }
