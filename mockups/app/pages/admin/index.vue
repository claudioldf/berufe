...
<style scoped>
.admin-page { min-height: 100vh; padding-bottom: 80px; background: #f2f0ea; }.admin-heading { padding: 32px 0 36px; background: #17352f; color: white; }.admin-heading__inner { display: flex; justify-content: space-between; align-items: end; gap: 20px; }.admin-heading .eyebrow { margin-bottom: 7px; color: #a7d7c8; }.admin-heading h1 { margin: 0; font-family: Georgia, serif; font-size: 2.6rem; font-weight: 500; letter-spacing: -.04em; }.admin-heading__inner > div:first-child > p:last-child { margin: 7px 0 0; color: rgba(255,255,255,.58); font-size: .7rem; }.admin-heading__user { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 9px; padding: 9px 11px; border: 1px solid rgba(255,255,255,.14); border-radius: 12px; background: rgba(255,255,255,.06); }.admin-heading__user > span { display: grid; place-items: center; width: 34px; height: 34px; border-radius: 9px; background: var(--coral); font-size: .78rem; font-weight: 900; }.admin-heading__user strong, .admin-heading__user small { display: block; }.admin-heading__user strong { font-size: .78rem; }.admin-heading__user small { margin-top: 2px; color: rgba(255,255,255,.55); font-size: .70rem; }.admin-heading__user > svg { color: #a7d7c8; }.admin-content { padding-top: 22px; }.admin-summary { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; margin-bottom: 18px; }.admin-summary article { display: flex; align-items: center; gap: 10px; padding: 15px; border: 1px solid var(--line); border-radius: 14px; background: white; }.admin-summary article > span { display: grid; place-items: center; width: 36px; height: 36px; border-radius: 10px; background: #f0eee8; }.admin-summary strong, .admin-summary small { display: block; }.admin-summary strong { font-family: Georgia, serif; font-size: 1.3rem; }.admin-summary small { color: var(--ink-soft); font-size: .72rem; }.admin-summary--warning > span { background: #fff2cf !important; color: #947019; }.admin-summary--success > span { background: var(--mint) !important; color: #397a69; }.admin-summary--error > span { background: #ffe8e4 !important; color: #b54b39; }.product-report { display: grid; gap: 16px; }.product-report__principle { display: flex; align-items: center; gap: 10px; padding: 14px; border: 1px solid #a7ccc0; border-radius: 13px; background: #e8f4f0; color: #397a69; }.product-report__principle > svg { font-size: 1.3rem; }.product-report__principle strong, .product-report__principle p { margin: 0; }.product-report__principle strong { font-size: .78rem; }.product-report__principle p { margin-top: 2px; color: var(--ink-soft); font-size: .72rem; }.product-report__metrics { display: grid; grid-template-columns: repeat(4, 1fr); gap: 9px; }.product-report__metrics article { padding: 17px; border: 1px solid var(--line); border-radius: 14px; background: white; }.product-report__metrics span, .product-report__metrics strong, .product-report__metrics em { display: block; }.product-report__metrics span { color: var(--ink-soft); font-size: .72rem; }.product-report__metrics strong { margin-top: 10px; font-family: Georgia, serif; font-size: 1.7rem; }.product-report__metrics em { margin-top: 5px; color: #397a69; font-size: .72rem; font-style: normal; font-weight: 850; }.product-report__grid { display: grid; grid-template-columns: 1.15fr .85fr; gap: 12px; }.product-report__grid > section { padding: 20px; }.product-report__grid header { display: flex; justify-content: space-between; gap: 10px; }.product-report__grid h2, .product-report__grid p { margin: 0; }.product-report__grid h2 { font-family: Georgia, serif; font-size: 1.25rem; }.product-report__grid p { margin-top: 3px; color: var(--ink-soft); font-size: .72rem; }.product-report__grid header > span { color: var(--ink-soft); font-size: .72rem; }.bar-list { display: grid; gap: 13px; margin-top: 22px; }.bar-list > div { display: grid; grid-template-columns: 105px 1fr 30px; gap: 8px; align-items: center; font-size: .72rem; }.bar-list i { overflow: hidden; height: 7px; border-radius: 99px; background: #e8e7e2; }.bar-list b { display: block; height: 100%; border-radius: inherit; background: #397a69; }.bar-list strong { text-align: right; }.gap-list { display: grid; gap: 11px; margin-top: 18px; }.gap-list > div { display: grid; grid-template-columns: auto 1fr; gap: 9px; align-items: center; padding: 11px; border-radius: 10px; background: #f7f5f0; }.gap-list > div > span { display: grid; place-items: center; width: 32px; height: 32px; border-radius: 9px; background: #fff0ec; color: #bf5944; }.gap-list strong, .gap-list small { display: block; }.gap-list strong { font-size: .75rem; }.gap-list small { margin-top: 3px; color: var(--ink-soft); font-size: .70rem; }
