        ...
        <section class="profile-section portfolio-section">
          ...
          <div class="portfolio-grid">
            ...
            >
              ...
              <span><strong>{{ item.title }}</strong><small>{{ item.service }}</small></span>
...
@media (max-width: 900px) { .profile-hero__grid { grid-template-columns: 1fr; }.profile-hero__contact { display: none; }.profile-content { grid-template-columns: 1fr; }.profile-sidebar { display: none; }.mobile-contact { position: fixed; z-index: 35; left: 12px; right: 12px; bottom: 12px; display: flex; justify-content: space-between; align-items: center; padding: 10px 10px 10px 14px; border: 1px solid rgba(255,255,255,.15); border-radius: 16px; background: #17352f; color: white; box-shadow: var(--shadow-lg); }.mobile-contact small, .mobile-contact strong { display: block; }.mobile-contact small { color: #a7d7c8; font-size: .58rem; text-transform: uppercase; }.mobile-contact strong { margin-top: 2px; font-size: .76rem; } }
