...
.hero__profile-chip small { margin-top: 3px; color: var(--ink-soft); font-size: .78rem; }
...
.hero__trust-chip span { font-size: .75rem; font-weight: 800; line-height: 1.25; }
...
.category-card small { display: -webkit-box; overflow: hidden; margin-top: 5px; color: var(--ink-soft); font-size: .78rem; line-height: 1.35; -webkit-line-clamp: 2; -webkit-box-orient: vertical; }
...
.trust__label strong { font-size: .8rem; }.trust__label small { margin-top: 3px; color: var(--ink-soft); font-size: .78rem; }
...
.featured-card__image span { position: absolute; left: 14px; bottom: 14px; padding: 7px 10px; border-radius: 9px; background: white; font-size: .78rem; font-weight: 800; }
.featured-card__body { display: flex; align-items: center; justify-content: space-between; padding: 17px 18px 12px; }
.featured-card__body strong, .featured-card__body small { display: block; }.featured-card__body strong { font-family: Georgia, serif; font-size: 1.2rem; }.featured-card__body small { display: flex; align-items: center; gap: 4px; margin-top: 5px; color: var(--ink-soft); font-size: .78rem; }
.featured-card__proof { display: flex; justify-content: space-between; gap: 8px; padding: 12px 18px 16px; border-top: 1px solid var(--line); color: var(--ink-soft); font-size: .78rem; font-weight: 700; }.featured-card__proof span { display: flex; align-items: center; gap: 4px; }.featured-card__proof span:first-child { color: #397a69; }
