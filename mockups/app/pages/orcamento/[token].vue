...
<template>
  <div class="shared-quote-page">
    <header class="shared-quote-page__header page-container"><NuxtLink to="/">berufe<span>.</span></NuxtLink><div><UIcon name="i-lucide-lock-keyhole" /> Link privado do orçamento</div></header>
...
<style scoped>
.shared-quote-page { min-height: 100vh; padding-bottom: 70px; background: #eeeae1; }.shared-quote-page__header { display: flex; justify-content: space-between; align-items: center; min-height: 70px; }.shared-quote-page__header > a { color: var(--ink); font-family: Georgia, serif; font-size: 1.4rem; font-weight: 700; letter-spacing: -.045em; text-decoration: none; }.shared-quote-page__header > a span { color: var(--coral); }.shared-quote-page__header > div { display: flex; align-items: center; gap: 5px; color: var(--ink-soft); font-size: .75rem; font-weight: 750; }.shared-quote-page main { max-width: 760px; }.shared-quote-page__heading { display: flex; justify-content: space-between; align-items: end; gap: 20px; margin: 42px 0 24px; }.shared-quote-page__heading p { margin: 0 0 6px; color: #397a69; font-size: .78rem; font-weight: 850; }.shared-quote-page__heading h1 { margin: 0; font-family: Georgia, serif; font-size: 2.5rem; font-weight: 500; letter-spacing: -.04em; }.shared-quote-page__heading span { display: block; max-width: 500px; margin-top: 7px; color: var(--ink-soft); font-size: .78rem; line-height: 1.5; }.shared-quote-page__notice { display: flex; align-items: flex-start; justify-content: center; gap: 5px; margin: 16px 0 0; color: var(--ink-soft); font-size: .75rem; text-align: center; }
@media (max-width: 600px) { .shared-quote-page__heading { display: grid; }.shared-quote-page__heading h1 { font-size: 2rem; } } @media print { .shared-quote-page__header, .shared-quote-page__heading, .shared-quote-page__notice { display: none; }.shared-quote-page { padding: 0; background: white; }.shared-quote-page main { width: 100%; max-width: none; } }
</style>
